            ...
            <tr>
                <td>
                    <div class="inner-body">
                        <h1>¡Hola {{ $userName }}!</h1>
                        <p>Lamentamos informarte que tu solicitud de Certificado de Avecindamiento, con id {{ $solicitudId }} ha sido anulada.</p>
                        <p>Puedes consultar los detalles de la anulación, haciendo clic en el siguiente enlace:</p>
                        <a href="{{ url('/versolicitudesavecindamiento') }}" class="button">Ver detalles</a>
