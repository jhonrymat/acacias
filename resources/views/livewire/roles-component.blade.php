    ...
    <form wire:submit.prevent="createOrUpdateRole" class="mb-6">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div class="col-span-2">
                ...
                <div
                    class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 max-h-60 overflow-y-auto p-2 border rounded-md">
                    @foreach ($allPermissions as $permission)
                        <div class="flex items-center">
                            ...
                            <label for="permission-{{ $permission->id }}" class="ml-2 text-sm text-gray-600"
                                title="{{ $permission->description ?? 'Sin descripción' }}"> <!-- Tooltip aquí -->
                                {{ $permission->name }}
                            </label>
                        </div>
                    @endforeach
        ...
        @foreach ($roles as $role)
            <li class="flex justify-between items-center py-3">
                ...
                <div class="flex gap-4">
                    <button wire:click="$dispatch('showRoleDetails', { Id: {{ $role->id }}})"
            ...
            <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
                <div class="mt-3 text-center">
                    ...
                    <div class="items-center px-4 py-3">
                        <button wire:click="hideRoleDetails"
