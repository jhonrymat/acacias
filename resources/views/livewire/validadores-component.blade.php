<div>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Validadores registrados') }}
        </h2>
    </x-slot>
    <!-- Botón para abrir el modal -->
    <div class="w-3/4 mx-auto py-6">
        <button wire:click="nuevoValidador" class="mb-4 px-4 py-2 bg-green-500 text-white rounded">Nuevo
            Validador</button>

        <!-- Tabla de validadores -->
        <livewire:validadores-datatable />
    </div>
            ...
            <div
                ...
                <div class="flex justify-between items-center mb-2">
                    <h2 class="text-xl font-bold">
                        <span>Formulario validadores</span>
                    </h2>
                </div>
                <form wire:submit.prevent="save">
                    <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <select id="rol" class="block mt-1 w-full" wire:model="rol">
