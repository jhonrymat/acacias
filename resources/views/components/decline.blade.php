<div x-data="{ open: false }" x-show="open"
    @decline.window="
        Swal.fire({
            ...
            text: event.detail.text || 'Vas a rechazar estas solicitudes, Esta acción no se puede deshacer.',
            ...
            if (result.isConfirmed) {
                Swal.fire({
                    title: '¿Seguro que deseas continuar con el rechazo todas las solicitudes?',
