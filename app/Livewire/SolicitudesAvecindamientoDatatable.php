...
class SolicitudesAvecindamientoDatatable extends DataTableComponent
{
    ...
    public function builder(): \Illuminate\Database\Eloquent\Builder
    {
        ...
        return SolicitudAvecindamiento::query()->where('user_id', $userId); // Filtra las solicitudes solo para el usuario autenticado
    }
