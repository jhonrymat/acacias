...
class SolicitudesAvecindamientoComponent extends Component
{
    ...
    {
        $validacion = ValidacionAvecindamiento::find($Id);
    ...
    public function verAnulacion($Id)
    {
        ...
        $anulacion = AnulacionAvecindamiento::where('solicitud_id', $Id)->first();
    ...
    {
        $solicitudes = SolicitudAvecindamiento::with('user')->get();

        return view('livewire.solicitudes-avecindamiento-component', [
